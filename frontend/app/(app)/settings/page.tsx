        ...
        <div className="mx-auto flex max-w-2xl flex-col gap-5">
          <PanelSection icon={User} title="Account">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="truncate text-sm font-medium text-gray-900 dark:text-gray-100">Yash Agarwal</p>
                <p className="truncate text-xs text-gray-500 dark:text-gray-400">yash21chess@gmail.com</p>
              </div>
              <span className="ml-auto shrink-0 rounded-full bg-gray-100 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                Default user
              </span>
            </div>
            <p className="mt-3.5 text-xs leading-relaxed text-gray-500 dark:text-gray-400">
          ...
          <PanelSection icon={Radio} title="Live meeting recording">
            ...
            <button
              ...
              className="control-focus mt-3.5 flex items-center gap-1.5 rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-600 transition-colors hover:border-gray-300 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:border-gray-600 dark:hover:bg-gray-800"
            >
              <Radio size={13} />
              Join a live call
            </button>
              ...
              {INTEGRATIONS.map(({ icon: Icon, name, description }) => (
                <div key={name} className="flex items-center gap-3 py-3 first:pt-0 last:pb-0">
                  ...
                  <button
                    ...
                    className="control-focus shrink-0 rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-600 transition-colors hover:border-gray-300 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:border-gray-600 dark:hover:bg-gray-800"
                  >
                    Connect
                  </button>
                </div>
