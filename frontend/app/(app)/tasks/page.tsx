  ...
  return (
    <>
      ...
      <main className="flex flex-1 flex-col items-center justify-center gap-3 px-6 py-24 text-center">
        ...
        <span className="rounded-full bg-gray-100 px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wide text-gray-500 dark:bg-gray-800 dark:text-gray-400">
          Coming soon
        </span>
        <h1 className="text-lg font-semibold text-gray-900 dark:text-gray-100">A unified view of every task</h1>
