    ...
    <div className="flex flex-1 flex-col overflow-hidden md:flex-row">
      <div className="flex-1 overflow-hidden px-4 py-6 sm:px-6">
        <div className="mx-auto flex max-w-3xl animate-pulse flex-col gap-5">
          ...
          <div className="h-16 rounded-xl border border-gray-100 bg-white shadow-sm" />
      ...
      <div className="hidden w-full shrink-0 border-t border-gray-200 bg-white md:block md:w-[380px] md:border-l md:border-t-0">
