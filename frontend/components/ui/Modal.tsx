  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative z-10 flex max-h-[90vh] w-full ${maxWidthClassName} flex-col rounded-xl border border-gray-200 bg-white shadow-2xl`}
      >
        <div className="flex shrink-0 items-center justify-between border-b border-gray-100 px-5 py-4">
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="control-focus rounded-md p-1 text-gray-400 transition-colors hover:bg-gray-100 hover:text-gray-600"
          >
            <X size={18} />
          </button>
        </div>
